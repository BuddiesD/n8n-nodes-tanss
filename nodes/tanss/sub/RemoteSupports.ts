...
export const remoteSupportsFields: INodeProperties[] = [
	{
		...
		default: {},
		options: [
			{ displayName: 'Device ID', name: 'deviceId', type: 'string' as const, default: '' },
...

	{
		...
		default: {},
		options: [
			{ displayName: 'User ID', name: 'userId', type: 'string' as const, default: '' },
...

	{
		...
		options: [
			{
				displayName: 'Remote Maintenance ID',
				name: 'remoteMaintenanceId',
				type: 'string' as const,
				default: '',
			},
			{ displayName: 'User ID', name: 'userId', type: 'string' as const, default: '' },
			{ displayName: 'User Name', name: 'userName', type: 'string' as const, default: '' },
			{ displayName: 'Employee ID', name: 'employeeId', type: 'number' as const, default: 0 },
			{ displayName: 'Device ID', name: 'deviceId', type: 'string' as const, default: '' },
			{ displayName: 'Device Name', name: 'deviceName', type: 'string' as const, default: '' },
			{ displayName: 'Company ID', name: 'companyId', type: 'number' as const, default: 0 },
			{ displayName: 'Link Type ID', name: 'linkTypeId', type: 'number' as const, default: 0 },
			{ displayName: 'Link ID', name: 'linkId', type: 'number' as const, default: 0 },
			{
			...
			{ displayName: 'End Time (Timestamp)', name: 'endTime', type: 'number' as const, default: 0 },
...
export async function handleRemoteSupports(this: IExecuteFunctions, i: number) {
	...
	if (!isGeneratedTokenMode.call(this, i)) {
		throw new NodeOperationError(
			this.getNode(),
			'Remote Supports API requires an external generated token with REMOTE_SUPPORT role. Switch Auth Mode to Generated Token API.',
		);
	}
