...
export const componentsFields: INodeProperties[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { displayName: 'componentTypeId', name: 'componentTypeId', type: 'number' as const, default: 0, description: 'id of the component type to be filtered' },
      ...
      { displayName: 'peripheryId', name: 'peripheryId', type: 'number' as const, default: 0, description: 'if only components of a given periphery shall be displayed' },
      {
...
export async function handleComponents(this: IExecuteFunctions, i: number) {
  ...
  try {
    ...
    if (operation === 'updateComponent' || operation === 'createComponent' || operation === 'updateComponentType' || operation === 'createComponentType') {
      if (responseData === '' || responseData == null) {
