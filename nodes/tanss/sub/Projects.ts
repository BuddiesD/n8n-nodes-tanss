...
export const projectFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			{ displayName: 'Project ID', name: 'projectId', type: 'number' as const, default: 0, description: 'ID of the project to assign the ticket to (0 to detach)' },
			{ displayName: 'Phase ID', name: 'phaseId', type: 'number' as const, default: 0, description: 'ID of the project phase to assign the ticket to' },
		],
	},
	{
		displayName: 'Options',
